/*
    Description: Creating a database and tables inside of it,
    altering tables' columns, adding constraints,
    inserting and selecting values from table, dropping table and database
*/
